...
www = { 'layout': 'monadtall', 'matches': [Match(wm_class=['Vivaldi-stable', 'Brave-browser', 'firefox'])]}
...
def init_screens():
    return [Screen(wallpaper='/usr/share/backgrounds/budgie/default.jpg', top=bar.Bar(widgets=init_widgets_screen1(), opacity=0.85, size=20)),
            Screen(wallpaper='/usr/share/backgrounds/budgie/default.jpg', top=bar.Bar(widgets=init_widgets_screen2(), opacity=0.85, size=20)),
